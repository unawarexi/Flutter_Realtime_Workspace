...
class ScheduleMeetController {
  ...
  static async createMeeting(req, res) {
    try {
      ...
      if (repeatOption && repeatOption !== 'None') {
        const recurringMeetings = await ScheduleMeetController.createRecurringMeetings(newMeeting);
   ...
   */
  static async createRecurringMeetings(parentMeeting) {
   ...
   * @param {Object} res - Express response object
   */
  static async getTodaysMeetings(req, res) {
    try {
      const { userID } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async postponeMeeting(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async permanentlyDeleteMeeting(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async restoreMeeting(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async recordParticipantJoin(req, res) {
    try {
      const { id, userID } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async recordParticipantLeave(req, res) {
    try {
      const { id, userID } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async getUserConflicts(req, res) {
    try {
      const { userID } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async getMeetingAnalytics(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async getUserMeetingStats(req, res) {
    try {
      const { userID } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async searchMeetings(req, res) {
    try {
      const {
        q: searchQuery,
        userID,
   ...
   * @param {Object} res - Express response object
   */
  static async bulkUpdateMeetings(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async bulkDeleteMeetings(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async createMeetingTemplate(req, res) {
    try {
      const {
        templateName,
        description,
   ...
   * @param {Object} res - Express response object
   */
  static async getMeetingTemplates(req, res) {
    try {
      ...
      const templates = await ScheduleMeet.find(filter)
        .sort({ createdAt: -1 })
        .select('-recurringMeetings -conflictingMeetings -participants -attachments');
   ...
   * @param {Object} res - Express response object
   */
  static async addMeetingNotes(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async updateMeetingNotes(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async convertMeetingTimezone(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async checkParticipantAvailability(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async addFollowUpAction(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async exportMeetingData(req, res) {
    try {
   ...
   * @param {Object} res - Express response object
   */
  static async updateRecurringSeries(req, res) {
    try {
      const { id } = req.params;
   ...
   * @param {Object} res - Express response object
   */
  static async cancelRecurringSeries(req, res) {
    try {
      const { id } = req.params;
...
export default ScheduleMeetController;
