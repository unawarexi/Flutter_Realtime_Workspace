...
export const validateTeamInput = [
  ...
  body("size")
    ...
    .withMessage("Invalid team size option"),
  ...
  body("settings.allowPublicProjects")
    .optional()
    .isBoolean()
    .withMessage("allowPublicProjects must be a boolean"),
  ...
  body("memberLimit")
    ...
    .withMessage("Member limit must be between 1 and 1000"),
...
export const validateInviteInput = [
  ...
  body("role")
    .optional()
    .isIn(["admin", "manager", "member", "viewer", "guest"])
